...
tc qdisc add dev ${OUT_INTERFACE} parent 1:10 handle 10 netem delay 100ms 10ms distribution normal loss 1% duplicate 5%
...
tc qdisc add dev ${OUT_INTERFACE} parent 1:20 handle 20 netem delay 50ms 5ms distribution normal loss 1% duplicate 5%
...
tc qdisc add dev ${OUT_INTERFACE} parent 1:30 handle 30 netem delay 50ms 5ms distribution normal loss 1% duplicate 5%
